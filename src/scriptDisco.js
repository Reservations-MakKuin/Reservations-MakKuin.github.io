...
if (date === '5/11/2026') {
   ...
   if(curentDate[1] < 10){
    ...
    if (event.target.className == 'event2' && localStorage.getItem('2') != null) {
       ...
       let splitted = event.target.textContent.trim().split(' ');
        ...
        document.getElementById('editBtn').addEventListener('click', () => {
            ...
            if (currentEvent.parentCatering.length > 0) {
                currentEvent.parentCatering.forEach((e) => {
                    ...
                    <option value="Салата Сънсет">Салата Сънсет</option>
                    <option value="Салата Гръцка">Салата Гръцка</option>
                    <option value="Салата Мексиканска">Салата Мексиканска</option>
                    <option value="Плато Деликатеси">Плато Деликатеси</option>
                    <option value="Пържени Картофи">Пържени Картофи</option>
                    <option value="Пикантни Картофи">Пикантни Картофи</option>
                    <option value="Плато Месни Хапки">Плато Месни Хапки</option>
            ...
            async function editReservation() {
                ...
                await put("/classes/ReservationDisco/" + currentEvent.objectId, {
                    "date": clicked.trim(),
        ...
        async function deleteReservation() {
            ...
            if (confirm('Сигурен ли си че искаш да изстриеш планираното събитие?')) {
                ...
                await del("/classes/ReservationDisco/" + currentEvent.objectId);
        ...
        if (event.target.children.length !== 7 && localStorage.getItem('2') != null) {
